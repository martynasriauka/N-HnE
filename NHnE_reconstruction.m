...
grayImages1 = cellfun(@(f) single(imread(fullfile(dirx, f))) / 255, grayImages1Files, 'UniformOutput', false);
grayImages2 = cellfun(@(f) single(imread(fullfile(dirx, f))) / 255, grayImages2Files, 'UniformOutput', false);
...
if imgNorm
    try
        ...
        grayImagesRef1 = cellfun(@(f) single(imread(fullfile(dirxref, f))) / 255, grayImages1FilesRef, 'UniformOutput', false);
        grayImagesRef2 = cellfun(@(f) single(imread(fullfile(dirxref, f))) / 255, grayImages2FilesRef, 'UniformOutput', false);
